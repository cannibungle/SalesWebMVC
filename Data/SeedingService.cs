...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1986, 11, 10), 4000, d1);
            Seller s2 = new Seller(2, "Mary Jane", "mary@gmail.com", new DateTime(1988, 1, 14), 3500, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1979, 11, 22), 2200, d1);
            Seller s4 = new Seller(4, "Donald Blue", "donald@gmail.com", new DateTime(1976, 8, 8), 3000, d4);
            Seller s5 = new Seller(5, "Peter Parker", "peter@gmail.com", new DateTime(1953, 12, 2), 1000, d3);
            Seller s6 = new Seller(6, "Bruce Wayne", "bruce@gmail.com", new DateTime(1999, 4, 27), 3000, d2);
